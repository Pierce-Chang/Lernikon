...
export const VOCABULARY_CORPUS: VocabularyEntry[] = [
  ...
  { bucket: "tiere", english: "bear", german: "Bar" },
  { bucket: "tiere", english: "lion", german: "Lowe" },
  ...
  { bucket: "zahlen", english: "five", german: "fuenf" },
  ...
  { bucket: "zahlen", english: "twelve", german: "zwoelf" },
  ...
  { bucket: "schule", english: "student", german: "Schueler" },
