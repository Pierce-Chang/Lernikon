...
import type { QuotaProps } from "./rechtschreibung-form-impl";
...
const Impl = dynamic(
  () =>
    import("./rechtschreibung-form-impl").then((m) => m.RechtschreibungFormImpl),
  { ssr: false, loading: FormSkeleton },
);

export const RechtschreibungForm = (props: {
  childId: string;
  quota: QuotaProps;
}) => <Impl {...props} />;
