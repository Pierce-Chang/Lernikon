...
import { RechtschreibungForm } from "./rechtschreibung-form";

export const metadata = { title: "Deutsch - Rechtschreibung" };

export default async function RechtschreibungPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-6 py-10">
      ...
      <h1 className="text-3xl font-bold tracking-tight">Rechtschreibung</h1>
      <p className="text-muted-foreground mt-1 text-sm">
        Fur <span className="font-medium">{child.name}</span> -{" "}
        {formatGradeShort(child.grade)}
      </p>
      <p className="text-muted-foreground mt-2 text-sm">
        Klasse 3. Eine Regel pro Blatt - oder gemischt.
      </p>
