...
import { WortartenForm } from "./wortarten-form";

export const metadata = { title: "Deutsch - Wortarten erkennen" };

export default async function WortartenPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-6 py-10">
      ...
      <h1 className="text-3xl font-bold tracking-tight">Wortarten erkennen</h1>
      <p className="text-muted-foreground mt-1 text-sm">
        Fur <span className="font-medium">{child.name}</span> -{" "}
        {formatGradeShort(child.grade)}
      </p>
      <p className="text-muted-foreground mt-2 text-sm">
        Klasse 2. Nomen, Verb oder Adjektiv ankreuzen.
      </p>
