...
import { WoerterForm } from "./woerter-form";

export const metadata = { title: "Deutsch · Wörter abschreiben" };

export default async function WoerterAbschreibenPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-6 py-10">
      ...
      <h1 className="text-3xl font-bold tracking-tight">Wörter abschreiben</h1>
      <p className="text-muted-foreground mt-1 text-sm">
        Für <span className="font-medium">{child.name}</span> ·{" "}
        {formatGradeShort(child.grade)} · Abschreiben mit Lineatur
      </p>
