...
import { SimpleSentencesForm } from "./simple-sentences-form";

export const metadata = { title: "Englisch · Simple Sentences" };

export default async function EnglischSimpleSentencesPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-6 py-10">
      ...
      <h1 className="text-3xl font-bold tracking-tight">Simple Sentences</h1>
      <p className="text-muted-foreground mt-1 text-sm">
        Fur <span className="font-medium">{child.name}</span>{" "}
        {formatGradeShort(child.grade)}
      </p>
      <p className="text-muted-foreground mt-2 text-sm">
        Klasse 4. Luckentext mit am, is, are: das Verb "to be" einsetzen.
      </p>
