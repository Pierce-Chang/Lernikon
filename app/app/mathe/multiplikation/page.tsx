...
import { MultiplikationForm } from "./multiplikation-form";

export const metadata = { title: "Mathe · Schriftliche Multiplikation" };

export default async function MatheMultiplikationPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-6 py-10">
      ...
      <h1 className="text-3xl font-bold tracking-tight">Schriftliche Multiplikation</h1>
