...
import { MengenForm } from "./mengen-form";

export const metadata = { title: "Mathe · Mengen 1-10" };

export default async function MengenPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-6 py-10">
      ...
      <h1 className="text-3xl font-bold tracking-tight">Mengen 1-10</h1>
      <p className="text-muted-foreground mt-1 text-sm">
        Fur <span className="font-medium">{child.name}</span> ·{" "}
        {formatGradeShort(child.grade)} · Formen zahlen und Ziffer eintragen
      </p>
