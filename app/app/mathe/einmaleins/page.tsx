...
import { EinmaleinsForm } from "./einmaleins-form";

export const metadata = { title: "Mathe · Einmaleins" };

export default async function MatheEinmaleinsPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-6 py-10">
      ...
      <h1 className="text-3xl font-bold tracking-tight">Einmaleins</h1>
