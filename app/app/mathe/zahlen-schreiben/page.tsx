...
import { ZahlenForm } from "./zahlen-form";

export const metadata = { title: "Mathe · Zahlen schreiben" };

export default async function ZahlenSchreibenPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-6 py-10">
      ...
      <h1 className="text-3xl font-bold tracking-tight">Zahlen schreiben</h1>
      <p className="text-muted-foreground mt-1 text-sm">
        Für <span className="font-medium">{child.name}</span> ·{" "}
        {formatGradeShort(child.grade)} · Druckschrift mit Lineatur
      </p>
