...
import { SchriftlichForm } from "./schriftlich-form";

export const metadata = { title: "Mathe · Schriftliche Verfahren" };

export default async function MatheSchriftlichPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-6 py-10">
      ...
      <h1 className="text-3xl font-bold tracking-tight">Schriftliche Verfahren</h1>
