...
import { RechnenForm } from "./rechnen-form";

export const metadata = { title: "Mathe · Rechnen" };

export default async function MatheRechnenPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-6 py-10">
      ...
      <h1 className="text-3xl font-bold tracking-tight">Rechnen (+ und −)</h1>
