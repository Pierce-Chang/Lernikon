...
export const metadata = { title: "Mathe · Schriftliche Division" };

export default async function MatheDivisionPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-6 py-10">
      ...
      <h1 className="text-3xl font-bold tracking-tight">Schriftliche Division</h1>
