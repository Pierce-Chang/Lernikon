...
import { FormenErkennenForm } from "./formen-erkennen-form";

export const metadata = { title: "Denken · Formen erkennen" };

export default async function FormenErkennenPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-6 py-10">
      ...
      <h1 className="text-3xl font-bold tracking-tight">Formen erkennen</h1>
      <p className="text-muted-foreground mt-1 text-sm">
        Fur <span className="font-medium">{child.name}</span> ·{" "}
        {formatGradeShort(child.grade)} · Geometrische Formen entdecken und ausmalen
      </p>
