...
import { MusterForm } from "./muster-form";

export const metadata = { title: "Denken · Muster fortsetzen" };
...
export default async function MusterPage() {
  ...
  return (
    <main className="mx-auto w-full max-w-2xl px-6 py-10">
      ...
      <h1 className="text-3xl font-bold tracking-tight">Muster fortsetzen</h1>
      <p className="text-muted-foreground mt-1 text-sm">
        Für <span className="font-medium">{child.name}</span> ·{" "}
        {formatGradeShort(child.grade)} · Formen-Muster erkennen und fortsetzen
      </p>
